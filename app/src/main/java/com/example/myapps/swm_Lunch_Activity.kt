...
import kotlinx.android.synthetic.main.activity_swm__lunch_.*
import kotlinx.android.synthetic.main.recycle_row_category.view.*

class swm_Lunch_Activity : AppCompatActivity() {
    val Lcategory: String = "Lunch"
    val adapter = GroupAdapter<GroupieViewHolder>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_swm__lunch_)

        wm_lunch_back.setOnClickListener {
            onBackPressed()
        }

        wm_lunch_textView.setOnClickListener {
            onBackPressed()
        }

        StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL).apply {
            wm_recycle_lunch.layoutManager = this
        }

        for(i in 0 until 6 step 1){
            adapter.add(loadItem())}
        wm_recycle_lunch.adapter = adapter
        ...
        override fun bind(viewHolder: GroupieViewHolder, position: Int) {
            if(position == 0){
                ...
                viewHolder.itemView.cons_break.setOnClickListener {
                    ...
                    intent.putExtra(swm_Lunch_Activity.rc_category,"Lunch")
                    intent.putExtra(swm_Lunch_Activity.rc_cuisine,"Western")
                ...
                viewHolder.itemView.cons_break.setOnClickListener {
                    val intent = Intent(it.context,wm_view_recipe_list_Activity::class.java)
                    intent.putExtra(swm_Lunch_Activity.rc_category,"Lunch")
                    intent.putExtra(swm_Lunch_Activity.rc_cuisine,"Chinese")
                    it.context.startActivity(intent)
                }
            }
            else if(position == 2){
                ...
                viewHolder.itemView.cons_break.setOnClickListener {
                    val intent = Intent(it.context,wm_view_recipe_list_Activity::class.java)
                    intent.putExtra(swm_Lunch_Activity.rc_category,"Lunch")
                    intent.putExtra(swm_Lunch_Activity.rc_cuisine,"Indian")
                    it.context.startActivity(intent)
                }
            }
            else if(position == 3){
                ...
                viewHolder.itemView.cons_break.setOnClickListener {
                    val intent = Intent(it.context,wm_view_recipe_list_Activity::class.java)
                    intent.putExtra(swm_Lunch_Activity.rc_category,"Lunch")
                    intent.putExtra(swm_Lunch_Activity.rc_cuisine,"Mexican")
                    it.context.startActivity(intent)
                }
            }
            else if(position == 4){
                ...
                viewHolder.itemView.cons_break.setOnClickListener {
                    val intent = Intent(it.context,wm_view_recipe_list_Activity::class.java)
                    intent.putExtra(swm_Lunch_Activity.rc_category,"Lunch")
                    intent.putExtra(swm_Lunch_Activity.rc_cuisine,"Italian")
                    it.context.startActivity(intent)
                }
            }
            else if(position == 5){
                ...
                viewHolder.itemView.cons_break.setOnClickListener {
                    val intent = Intent(it.context,wm_view_recipe_list_Activity::class.java)
                    intent.putExtra(swm_Lunch_Activity.rc_category,"Lunch")
                    intent.putExtra(swm_Lunch_Activity.rc_cuisine,"Thai")
                    it.context.startActivity(intent)
                }
